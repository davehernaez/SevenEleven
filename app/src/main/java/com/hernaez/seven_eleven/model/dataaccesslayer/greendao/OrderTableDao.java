...
/** 
 * DAO for table "ORDER_TABLE".
*/
public class OrderTableDao extends AbstractDao<OrderTable, Long> {

    public static final String TABLENAME = "ORDER_TABLE";

    /**
     * Properties of entity OrderTable.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property ProductPrice = new Property(3, Double.class, "productPrice", false, "PRODUCT_PRICE");
        public final static Property ProductSubtotal = new Property(4, Double.class, "productSubtotal", false, "PRODUCT_SUBTOTAL");
        public final static Property ProductImgPath = new Property(5, String.class, "productImgPath", false, "PRODUCT_IMG_PATH");
    };


    public OrderTableDao(DaoConfig config) {
        super(config);
    }
    
    public OrderTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORDER_TABLE\" (" + //
                "\"_id\" INTEGER PRIMARY KEY ," + // 0: id
                "\"PRODUCT_NAME\" TEXT," + // 1: productName
                "\"PRODUCT_QTY\" INTEGER," + // 2: productQty
                "\"PRODUCT_PRICE\" REAL," + // 3: productPrice
                "\"PRODUCT_SUBTOTAL\" REAL," + // 4: productSubtotal
                "\"PRODUCT_IMG_PATH\" TEXT);"); // 5: productImgPath
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ORDER_TABLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrderTable entity) {
        stmt.clearBindings();
        ...
        Double productSubtotal = entity.getProductSubtotal();
        if (productSubtotal != null) {
            stmt.bindDouble(5, productSubtotal);
        }
    ...
    /** @inheritdoc */
    @Override
    public OrderTable readEntity(Cursor cursor, int offset) {
        OrderTable entity = new OrderTable( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getDouble(offset + 3), // productPrice
            cursor.isNull(offset + 4) ? null : cursor.getDouble(offset + 4), // productSubtotal
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrderTable entity, int offset) {
        ...
        entity.setProductPrice(cursor.isNull(offset + 3) ? null : cursor.getDouble(offset + 3));
        entity.setProductSubtotal(cursor.isNull(offset + 4) ? null : cursor.getDouble(offset + 4));
        entity.setProductImgPath(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrderTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrderTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
